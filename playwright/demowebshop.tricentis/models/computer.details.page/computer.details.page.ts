...
thì đem constructor của Teo ra ngoài để init 1 cái object của Teo: [new(compLct: Locator)] 
sau đó trả về Teo type (chứ không phải là instance của Teo): [=> Teo;]
*/
export type ComputerCompConstructor<Teo extends ComputerEssentialComp> = new(compLct: Locator) => Teo;
