...
export class FooterFlows2 extends BasePage {
    ...
    private async verifyInfoColumn(): Promise<void> {
        ...
        const infoColumnComp2 = this.homePage.footerGenericComp().footerColumnComp2(InfoColumnComp2);

        await this.verifyFooterColumn(infoColumnComp2, expectedLinkTexts, expectedLinks);
    ...
    private async verifyFooterColumn(
        FooterGenericComp: FooterGenericComp,
        ...
        const linkLcts = await FooterGenericComp.linkLcts();
